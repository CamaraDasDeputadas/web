  ...
  ngOnInit() {
    ...
    this.perguntas = [
      ...
      {texto: 'Qual a porcentagem de deputadas sendo investigadas por alguma irregularidade?', idxResposta: 3, opcoes: [
        ...
        explanation: '15 das 53 mulheres estão sendo investigadas, duas delas por por ações penais (processos que podem acabar em condenação) e o restante respondem na justiça por inquéritos (procedimentos que podem resultar em processos), podendo ser incluídas na Lei da Ficha Limpa.'
      },
